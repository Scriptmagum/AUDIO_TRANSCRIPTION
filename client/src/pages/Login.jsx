    ...
    <div className="min-h-screen w-full bg-[#09090b] text-white font-sans flex flex-col items-center justify-center relative overflow-hidden px-4">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-extrabold tracking-tight text-white">Connexion</h1>
          <p className="text-sm text-gray-400 mt-2">Accédez à votre espace Meeting AI</p>
        </div>
        ...
        <div className="bg-[#121214] border border-gray-800 rounded-2xl p-8 shadow-2xl shadow-black">
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-400">
              <button onClick={navigateToRegister} className="text-yellow-500 font-bold hover:text-yellow-400 transition-colors">
                Créer un compte
              </button>
            </p>
          </div>
